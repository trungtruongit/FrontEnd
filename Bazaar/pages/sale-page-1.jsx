...
import api from "utils/__api__/sales"; // import productsList from "data/product-database";
...
const SalePage1 = () => {
  ...
  const { isFixedHeader } = useScroller(categoryRef); // HANDLE CHANGE PAGE

  const handlePageChange = (_, page) => setPage(page); // HANDLE THE CHANGE CATEGORY

  const handleCategoryChange = (category) => () =>
    setSelectedCategory(category); // FETCH CATEGORIES FROM SERVER
